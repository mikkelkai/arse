...
test('render test', function (t) {
  ...
  var noMountNode = function noMountNode() {
    return (0, _DOM2.default)(Test);
  };
  t.throw(noMountNode, 'Throws on no mountNode');

  var noDispatchUndefined = (0, _DOM2.default)(Test, root);
  ...
  t.equal('undefined', typeof noDispatchNull === 'undefined' ? 'undefined' : _typeof(noDispatchNull), 'Returns undefined when provided null value');
  ...
  var dispatch = (0, _DOM2.default)(Test, root, testState, reducer);
  t.equal('function', typeof dispatch === 'undefined' ? 'undefined' : _typeof(dispatch), 'Returns a function when provided a reducer function');
